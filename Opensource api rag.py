...
API_BASE_URL = "https://mobileapm.eg-innovations.com/api/eg/analytics"
HEADERS = {
    "user": "apiaccess",
    "pwd": "YXBpYWNjZXNzQDEyMw==",
    "managerurl": "https://10.200.2.192:7077",
    "accessID": "60b42ea82196f325a6888eac870b13f6a081f97b7b4b4da49a440b612c2abc62",
}
API_ENDPOINTS = {
...
def fetch_all_api_data():
    ...
    for api_name, endpoint in API_ENDPOINTS.items():
        try:
            ...
            payload = {"componentName": "10.200.2.192:7077", "componentType": "eG Manager"} if api_name == "metrics" else {"filterBy": "ComponentType", "filterValues": "eG Manager"}
